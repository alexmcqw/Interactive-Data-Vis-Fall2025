...
- **Overall Statistics**: The mean response time is shown as a blue dashed line on the chart, suggesting some stations have outlier slow response times that skew the average.
